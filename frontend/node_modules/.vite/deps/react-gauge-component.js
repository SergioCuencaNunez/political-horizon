import {
  ...
  zip,
  zoom_default
} from "./chunk-6G2VDAGJ.js";
import {
  require_lodash
} from "./chunk-R23UJSFX.js";
import {
  require_react
...
var require_Arc = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/types/Arc.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.defaultArc = exports.getArcWidthByType = exports.defaultSubArcs = void 0;
    var GaugeComponentProps_1 = require_GaugeComponentProps();
    exports.defaultSubArcs = [
      { limit: 33, color: "#5BE12C" },
      { limit: 66, color: "#F5CD19" },
      { color: "#EA4228" }
    ];
    var getArcWidthByType = function(type2) {
      var _a;
      ...
      if (!type2)
        type2 = GaugeComponentProps_1.defaultGaugeProps.type;
      return gaugeTypesWidth[type2];
    };
...
var require_Tick = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/types/Tick.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_Labels = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/types/Labels.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.defaultLabels = exports.defaultValueLabel = void 0;
    var Tick_1 = require_Tick();
...
var require_Pointer = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/types/Pointer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function(PointerType2) {
      PointerType2["Needle"] = "needle";
      PointerType2["Blob"] = "blob";
      PointerType2["Arrow"] = "arrow";
...
var require_GaugeComponentProps = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/types/GaugeComponentProps.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var GaugeType;
    (function(GaugeType2) {
      GaugeType2["Semicircle"] = "semicircle";
      GaugeType2["Radial"] = "radial";
      GaugeType2["Grafana"] = "grafana";
    ...
    var getGaugeMarginByType = function(type2) {
      var _a;
      var gaugeTypesMargin = (_a = {}, _a[GaugeType.Grafana] = { top: 0.12, bottom: 0, left: 0.07, right: 0.07 }, _a[GaugeType.Semicircle] = { top: 0.08, bottom: 0, left: 0.08, right: 0.08 }, _a[GaugeType.Radial] = { top: 0.07, bottom: 0, left: 0.07, right: 0.07 }, _a);
      return gaugeTypesMargin[type2];
    };
...
var require_utils = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/hooks/utils.js"(exports) {
    "use strict";
    ...
    var percentToRad = function(percent, angle2) {
      return percent * (Math.PI / angle2);
    };
    ...
    function normalize2(value, min3, max4) {
      return (value - min3) / (max4 - min3) * 100;
    }
    exports.normalize = normalize2;
    var degToRad = function(degrees2) {
...
var require_constants = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/constants.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_Tooltip = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/types/Tooltip.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_arc = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/hooks/arc.js"(exports) {
    "use strict";
    ...
    var d3_1 = (init_src31(), __toCommonJS(src_exports));
    var arcHooks = __importStar(require_arc());
    var constants_1 = __importDefault(require_constants());
    var Tooltip_1 = require_Tooltip();
    var GaugeComponentProps_1 = require_GaugeComponentProps();
      ...
      if ((arc === null || arc === void 0 ? void 0 : arc.subArcs) && !(arc === null || arc === void 0 ? void 0 : arc.nbSubArcs)) {
        ...
        (_b = arc === null || arc === void 0 ? void 0 : arc.subArcs) === null || _b === void 0 ? void 0 : _b.forEach(function(subArc, i) {
          ...
          if (subArc.length != void 0) {
            ...
            var remainingPercentageEquallyDivided = void 0;
            var remainingSubArcs = (_a2 = arc === null || arc === void 0 ? void 0 : arc.subArcs) === null || _a2 === void 0 ? void 0 : _a2.slice(i);
          ...
          lastSubArcLimitPercentageAcc_1 = subArcsLength_1.reduce(function(count3, curr) {
            return count3 + curr;
          }, 0);
          lastSubArcLimit_1 = limit;
          if (subArc.tooltip != void 0)
    ...
    var getGrafanaMainArcData = function(gauge, percent) {
      ...
      var currentPercentage = percent != void 0 ? percent : utils.calculatePercentage(gauge.props.minValue, gauge.props.maxValue, gauge.props.value);
    ...
    var getColors = function(nbArcsToDisplay, gauge) {
      ...
      if (!arc.colorArray) {
        ...
        colorsValue = (subArcColors === null || subArcColors === void 0 ? void 0 : subArcColors.some(function(color2) {
      ...
      if (arcsEqualsColorsLength)
        return colorsValue;
      var colorScale = (0, d3_1.scaleLinear)().domain([1, nbArcsToDisplay]).range([colorsValue[0], colorsValue[colorsValue.length - 1]]).interpolate(d3_1.interpolateHsl);
      var colorArray = [];
    ...
    var createGradientElement = function(div, uniqueId) {
      var lg = div.append("defs").append("linearGradient").attr("id", uniqueId).attr("x1", "0%").attr("x2", "100%").attr("y1", "0%").attr("y2", "0%");
      return lg;
    };
    ...
    var getCoordByValue = function(value, gauge, position, centerToArcLengthSubtract, radiusFactor) {
      ...
      var angle2 = startAngle + percent * (endAngle - startAngle);
      var coordsRadius = 1 * (gauge.dimensions.current.width / 500);
      var coord = [0, -coordsRadius / 2];
      var coordMinusCenter = [
        coord[0] - centerToArcLength * Math.cos(angle2),
        coord[1] - centerToArcLength * Math.sin(angle2)
      ];
      var centerCoords = [gauge.dimensions.current.outerRadius, gauge.dimensions.current.outerRadius];
      var x3 = centerCoords[0] + coordMinusCenter[0];
      var y3 = centerCoords[1] + coordMinusCenter[1];
      return { x: x3, y: y3 };
    };
...
var require_labels = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/hooks/labels.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    var constants_1 = __importDefault(require_constants());
    var Tick_1 = require_Tick();
    var d3 = __importStar((init_src31(), __toCommonJS(src_exports)));
    var GaugeComponentProps_1 = require_GaugeComponentProps();
    var arc_1 = require_arc();
    ...
    var setupTicks = function(gauge) {
      ...
      if (constants_1.default.debugTicksRadius) {
        for (var index3 = 0; index3 < maxValue; index3++) {
          var indexTick = (0, exports.mapTick)(index3, gauge);
    ...
    var addTickLine = function(tick, gauge) {
      ...
      var labels = gauge.props.labels;
      var _u = (0, exports.calculateAnchorAndAngleByValue)(tick === null || tick === void 0 ? void 0 : tick.value, gauge), tickAnchor = _u.tickAnchor, angle2 = _u.angle;
      ...
      if (((_t = labels === null || labels === void 0 ? void 0 : labels.tickLabels) === null || _t === void 0 ? void 0 : _t.type) == "inner") {
        endX = coords.x + tickLength * Math.cos(angle2 * Math.PI / 180);
        endY = coords.y + tickLength * Math.sin(angle2 * Math.PI / 180);
      } else {
        endX = coords.x - tickLength * Math.cos(angle2 * Math.PI / 180);
        endY = coords.y - tickLength * Math.sin(angle2 * Math.PI / 180);
      }
      ...
      gauge.g.current.append("path").datum(lineCoordinates).attr("class", constants_1.default.tickLineClassname).attr("d", lineGenerator).attr("stroke", tickColor).attr("stroke-width", tickWidth).attr("fill", "none");
    };
    ...
    var getLabelCoordsByValue = function(value, gauge, centerToArcLengthSubtract) {
      ...
      var minValue = gauge.props.minValue;
      var maxValue = gauge.props.maxValue;
      var type2 = (_a = labels.tickLabels) === null || _a === void 0 ? void 0 : _a.type;
      var _b = (0, arc_1.getCoordByValue)(value, gauge, type2, centerToArcLengthSubtract, 0.93), x3 = _b.x, y3 = _b.y;
    ...
    var addText = function(html2, x3, y3, gauge, style, className, rotate) {
      if (rotate === void 0) {
        rotate = 0;
      }
      var div = gauge.g.current.append("g").attr("class", className).attr("transform", "translate(".concat(x3, ", ").concat(y3, ")")).append("text").text(html2);
    ...
    var addValueText = function(gauge) {
      ...
      var x3 = gauge.dimensions.current.outerRadius;
      var y3 = 0;
      valueTextStyle.textAnchor = "middle";
      if (gauge.props.type == GaugeComponentProps_1.GaugeType.Semicircle) {
        y3 = gauge.dimensions.current.outerRadius / 1.5 + textPadding;
      } else if (gauge.props.type == GaugeComponentProps_1.GaugeType.Radial) {
        y3 = gauge.dimensions.current.outerRadius * 1.45 + textPadding;
      } else if (gauge.props.type == GaugeComponentProps_1.GaugeType.Grafana) {
        y3 = gauge.dimensions.current.outerRadius * 1 + textPadding;
      }
      var widthFactor = gauge.props.type == GaugeComponentProps_1.GaugeType.Radial ? 3e-3 : 3e-3;
      ...
      (0, exports.addText)(text, x3, y3, gauge, valueTextStyle, constants_1.default.valueLabelClassname);
    };
    ...
    var calculateAnchorAndAngleByValue = function(value, gauge) {
      ...
      var angle2 = startAngle + valuePercentage * 100 * endAngle / 100;
      ...
      return { tickAnchor, angle: angle2 };
    };
    ...
    var shouldHideTickValue = function(tick, gauge) {
      ...
      if (defaultHideValueFromUser != void 0) {
...
var require_pointer = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/hooks/pointer.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m3, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m3, k);
    ...
    var drawPointer = function(gauge, resize) {
      ...
      var isFirstTime = ((_a = gauge.prevProps) === null || _a === void 0 ? void 0 : _a.current.value) == void 0;
    ...
    var setPointerPosition = function(pointerRadius, progress, gauge) {
      ...
      var pointers = (_a = {}, _a[Pointer_1.PointerType.Needle] = function() {
        ...
        var _a2 = (0, arc_1.getCoordByValue)(value, gauge, "inner", 0, 0.7), x3 = _a2.x, y3 = _a2.y;
        x3 -= 1;
        y3 += pointerRadius - 3;
        (0, exports.translatePointer)(x3, y3, gauge);
      }, _a[Pointer_1.PointerType.Blob] = function() {
        var _a2 = (0, arc_1.getCoordByValue)(value, gauge, "between", 0, 0.75), x3 = _a2.x, y3 = _a2.y;
        x3 -= 1;
        y3 += pointerRadius;
        (0, exports.translatePointer)(x3, y3, gauge);
      }, _a);
    ...
    var isProgressValid = function(currentPercent, prevPercent, gauge) {
      ...
      var tooSmallValue = Math.abs(currentPercent - prevPercent) < 1e-4;
    ...
    var calculatePointerPath = function(gauge, percent) {
      ...
      var angle2 = startAngle + percent * (endAngle - startAngle);
      var topPoint = [
        centerPoint[0] - pathLength * Math.cos(angle2),
        centerPoint[1] - pathLength * Math.sin(angle2)
      ];
      var thetaMinusHalfPi = angle2 - Math.PI / 2;
      var leftPoint = [
        centerPoint[0] - pointerRadius * Math.cos(thetaMinusHalfPi),
        centerPoint[1] - pointerRadius * Math.sin(thetaMinusHalfPi)
      ];
      var thetaPlusHalfPi = angle2 + Math.PI / 2;
      var rightPoint = [
    ...
    var translatePointer = function(x3, y3, gauge) {
      return gauge.pointer.current.element.attr("transform", "translate(" + x3 + ", " + y3 + ")");
    };
...
var require_chart = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/hooks/chart.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m3, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m3, k);
    ...
    var GaugeComponentProps_1 = require_GaugeComponentProps();
    var arcHooks = __importStar(require_arc());
    var labelsHooks = __importStar(require_labels());
    var pointerHooks = __importStar(require_pointer());
...
var require_Dimensions = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/types/Dimensions.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_GaugeComponent = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/index.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    var d3_1 = (init_src31(), __toCommonJS(src_exports));
    var GaugeComponentProps_1 = require_GaugeComponentProps();
    var chartHooks = __importStar(require_chart());
    var arcHooks = __importStar(require_arc());
    ...
    var GaugeComponent = function(props) {
      ...
      var id2 = props.id, style = props.style, className = props.className, type2 = props.type;
      return react_1.default.createElement("div", { id: id2, className: "".concat(gauge.props.type, "-gauge").concat(className ? " " + className : ""), style, ref: function(svg3) {
        return selectedRef.current = svg3;
      } });
    };
...
var require_lib = __commonJS({
  "node_modules/react-gauge-component/dist/lib/index.js"(exports) {
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.GaugeComponent = void 0;
    var GaugeComponent_1 = __importDefault(require_GaugeComponent());
